...
const getPgVersion = async (req: CustomRequest): Promise<string> => {
  try {
...
routes.get('/', async (req: Request, res: Response) => {
  const status = await getPgVersion(req as CustomRequest);
...
// Rota de integração com OpenAI
routes.post('/openai', OpenAIController.generateText);
